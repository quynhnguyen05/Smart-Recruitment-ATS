  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-8 flex flex-wrap gap-3">
        ...
        {isMounted && (role === "ADMIN" || role === "RECRUITER") && <><button onClick={() => router.push("/create-job")} className="px-4 py-2 bg-[#1D4ED8] text-white rounded-md">Tạo vị trí mới</button><button onClick={() => router.push("/cv-review")} className="px-4 py-2 border border-blue-200 text-blue-700 rounded-md">Xem hồ sơ ứng tuyển</button></>}
